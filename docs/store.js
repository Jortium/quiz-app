const STORE = [
      ...
      //Question 8
      {
            ...
            choices:[`Zelda`, `Link`, `Epona`, `Shiek`];
            answer:`Link`;
      },
      //Question 9
      {
